...
class Config:
    ...
    IMG_GALLERY = ['https://i.ibb.co/zhNZL4FF/IMG-9198.jpg', 'https://i.ibb.co/Y4B7CbXf/IMG-9202.jpg', 'https://i.ibb.co/Fqf0gPPq/IMG-9199.jpg']
    IMG_HOME_PREVIEWS = ['https://i.ibb.co/k2MJg4XC/Save-ClipApp-412457343-378531441368078-7870326395110089440-n.jpg', 'https://i.ibb.co/MxqKBk1X/Save-ClipApp-481825770-18486618637042608-2702272791254832108-n.jpg', 'https://i.ibb.co/F4CkkYTL/Save-ClipApp-461241348-1219420546053727-2357827070610318448-n.jpg']
...
class UiService:
    ...
    def show_call_effect():
        ...
        ">
            ...
            <p style="font-size: 0.9rem; margin:0;">Juh está te esperando...</p>  <!-- Alterado de Juh para Juh -->
        </div>
        """, unsafe_allow_html=True)
